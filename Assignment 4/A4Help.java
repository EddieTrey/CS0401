...
public class A4Help
{
	public static void main(String [] args)
	{
		...
		// Note the loops below carefully.  These will be very helpful when
		// generating your Card objects for your War game.  Think about how
		// you can use loops like these to initialize your deck.
